    ...
    <div className="min-h-screen bg-gradient-to-tr from-blue-900 via-blue-800 to-blue-700 text-slate-100 px-8 py-16 font-mono select-none">
      ...
      <header className="flex-1 text-center md:text-left">
        ...
        <p className="text-lg max-w-xl text-slate-300">
          I’m an 18-year-old developer from Israel, constantly pushing myself to learn and build more, Driven by curiosity and a love for programming, I specialize in building real-world apps with clean, scalable code across the full stack — all self-taught through hands-on projects and personal dedication.
        </p>
